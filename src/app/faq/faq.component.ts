...
export class FaqComponent implements OnInit {
  ...
  content = [
    {
      header: "What is a clinical trial?",
    ...
    {
      header: "Where can I find a clinical trial that fits my needs?",
    ...
    {
      header: "What are my responsibilities if I am enrolled into a clinical trial?",
    ...
    {
      header: "What if I decide I don’t want to participate anymore?",
    ...
    {
      header: "Will my insurance be billed for my participation in a trial?",
